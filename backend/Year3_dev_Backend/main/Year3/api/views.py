...
#             option = request.GET.get(
#                 "option"
#             )  #!< query parameter inside an URL is a string not a integer
...
#                 "node_id"
#             )  #!< query parameter inside an URL is a string not a integer
#             time_start = request.GET.get(
#                 "time_start"
#             )  #!< query parameter inside an URL is a string not a integer
#             time_end = request.GET.get(
#                 "time_end"
#             )  #!< query parameter inside an URL is a string not a integer
#             # print(str(option), int(room_id), int(node_id), int(time_start), int(time_end))
#             result_data = None
#             if option == "day":
#                 result_data = getOptionDayData(
#                     int(time_start), int(room_id), int(node_id)
#                 )
#                 return Response(result_data, status=status.HTTP_200_OK)
#             elif option == "month":
#                 result_data = getOptionMonthData(
#                     int(time_start), int(time_end), int(room_id), int(node_id)
#                 )
#                 return Response(result_data, status=status.HTTP_200_OK)
#             elif option == "year":
#                 result_data = getOptionYearData(
#                     int(time_start), int(time_end), int(room_id), int(node_id)
#                 )
#                 return Response(result_data, status=status.HTTP_200_OK)
#             else:
#                 return Response(
#                     {"Response": "Option provided is NOT valid"},
#                     status=status.HTTP_400_BAD_REQUEST,
#                 )
#         else:
#             return Response(
#                 {"Response": "Option is not provided"},
#                 status=status.HTTP_400_BAD_REQUEST,
#             )
#     except:
#         return Response(
