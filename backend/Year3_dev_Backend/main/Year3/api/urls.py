...
urlpatterns = [
    ...
    path(
        "configuration/room/all", views.getConfigurationRoomAll
    ),  #!< api for InformationTag component
    path(
        "configuration/room/command", views.configurationRoom
    ),  #!< api for InformationTag component
    path(
        "configuration/node/command", views.configurationNode
    ),  #!< api for InformationTag component
